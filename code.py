...
main_application.title('SN text editor')
main_application.wm_iconbitmap('icon.ico')


############################################## main menu ###################################################
# develop by shambhu kumar @central university of haryana 
# email- toshambhunirala@gmail.com 
# mob - 8789304698
# -------------------------------------&&&&&&&& End main menu &&&&&&&&&&& ----------------------------------
main_menu = tk.Menu()
#file icons
...
status_bar = ttk.Label(main_application, text = 'By- Shambhu Nirala (*_*) Editor Status is:')
